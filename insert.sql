...
-- ------------------------------------------------------------
-- Department (insert without dept_head first to avoid FK issue)
-- ------------------------------------------------------------
...
(1, 'Claude',  NULL, 'Monet',    'French',   1840, 1926, 'Pioneer of the Impressionist movement.'),
(2, 'Vincent', NULL, 'van Gogh', 'Dutch',    1853, 1890, 'Post-Impressionist painter known for vivid colors.'),
(3, 'Frida',   NULL, 'Kahlo',    'Mexican',  1907, 1954, 'Known for self-portraits and works inspired by Mexican folk art.'),
(4, 'Pablo',   NULL, 'Picasso',  'Spanish',  1881, 1973, 'Co-founder of Cubism.'),
...
(1, 1),  -- Water Lilies in Impressionism exhibit
(1, 2),  -- Starry Night in Impressionism exhibit
(1, 6),  -- Haystacks in Impressionism exhibit
(2, 3),  -- Self-Portrait in Modern Visions
(2, 4),  -- Guernica in Modern Visions
(2, 8),  -- The Two Fridas in Modern Visions
(3, 5),  -- Black Iris in Nature and Form
(3, 7);  -- Irises in Nature and Form
...
-- Membership
-- ------------------------------------------------------------
INSERT INTO Membership (Member_ID, Email, Tier, Start_date, End_date, Price) VALUES
(1, 'alice.smith@email.com', 'Premium',  '2024-01-01', '2024-12-31', 150.00),
(2, 'bob.jones@email.com',   'Basic',    '2024-02-01', '2025-01-31',  50.00),
(3, 'carol.white@email.com', 'Standard', '2024-03-15', '2025-03-14', 100.00),
(4, 'david.kim@email.com',   'Premium',  '2023-06-01', '2024-05-31', 150.00),
(5, 'eva.nguyen@email.com',  'Basic',    '2024-04-01', '2025-03-31',  50.00);
